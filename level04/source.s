...
; ------------------------------------------------------- if1
   ...
   0x0804878c <+196>:   je     0x80487ac <main+228>; if (wait(0) & 0x7f) == 0 { jmp main +228 }
; ------------------------------------------------------- if2
...
;  ------------------------------------------------------ if2 content
   ...
   0x080487e1 <+281>:   mov    DWORD PTR [esp+0xa8],eax; status = eax de ptrace
   0x080487e8 <+288>:   cmp    DWORD PTR [esp+0xa8],0xb
   0x080487f0 <+296>:   jne    0x8048768 <main+160>; <-- while loop ?
;  ------------------------------------------------------
